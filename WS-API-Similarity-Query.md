## Message Type
[`Q_SIM`](Message-Type-Glossary#q_sim)

## Description
Executes the similarity-query based on the [`QueryComponent`](Objects-Glossary#querycomponent) objects provided in the [`SimilarityQuery`](Objects-Glossary#similarityquery).

## Request Description
* A [`SimilarityQuery`](Objects-Glossary#similarityquery) message is to be sent for query.
...
* The similarity query result will consist of a series of messages.
