...
Each feature module uses a particular shot descriptor as its input. Shot descriptors are aggregates of a subset of information of a shot. Three different such aggregations are available:
...
The average image contains the pixel- and color-channel wise arithmetic mean of all video frames of a shot.

### Median Image

The median image contains the pixel- and color-channel wise median of all video frames of a shot.

### Most Representative Frame

The most representative frame of a shot is the one which has the smallest pixel-wise Euclidean color distance to the average image
